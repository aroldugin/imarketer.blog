exports.id = "component---src-templates-tag-js";
exports.ids = ["component---src-templates-tag-js"];
exports.modules = {
...
}, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h1", null, "#", data.wpTag.name), data.allWpPost.nodes.map((post, node, nodes) => {
  const {
    slug,
    id,
    title,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (TagTemplate);
const query = "2503451063";
